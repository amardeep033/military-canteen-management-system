...
<body>
	...
	<?php
		...
		if(!empty($sid)) {
		$qry1 = "SELECT pr_id,sale_qty,tot_price FROM sales_items where sale_id=$sid";
		...
		$sum=0;
			...
			while($row1 = $result1->fetch_assoc()) {
					...
					$medid=$row1["pr_id"];
					$qry2 = "SELECT pr_name,pr_price FROM products where pr_id=$medid";
				...
				echo "<tr>";
					...
					echo "<a name='delete' class='button1 del-btn' href=pharm-pos-delete.php?mid=".$row1['pr_id']."&slid=".$sid.">Delete</a>";	
					echo "</td>";
				echo "</tr>";
				}
			echo "</table>";
